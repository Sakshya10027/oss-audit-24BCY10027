...
**GIT** — A distributed version control system licensed under GPL v2, originally created by Linus Torvalds in 2005.
...
```bash
git clone https://github.com/Sakshya10027/oss-audit-24BCY10027.git
cd oss-audit-24BCY10027
```
